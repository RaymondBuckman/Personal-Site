        ...
        <div> 
            <div className="Intro-1" id="top-of-page">
                        ...
                        <div className="col-md-4 col-md-offset-4 text-center">
                            <span id="down-arrow" className="glyphicon glyphicon-menu-down" data-tip data-for="scroll" aria-describedby="scroll"></span>
                        </div>
            </div>
            ...
            <div className="Intro-2" id="arrow-dest">
                <ul className="flex-container">
                    ...
                    <li className="flex-item">
                        <h1 id="about-me" className="scrollmagicFadeIn">Ab<span id="aboutMe_o">o</span><span id="aboutMe_ut">ut</span> <span id="aboutMe_M">M</span><span id="aboutMe_e">e</span>
                        </h1><br/>
                        <p id="about-me-paragraph" className="scrollmagicFadeIn">I am an enthusiastic, driven college graduate looking for a rewarding entry-level position in tech. Currently, I am seeking employment opportunities that will both challenge me &
            ...
            <nav className="navbar navbar-default hidden-xs" role="navigation">
                <div className="container">
                    <ul className="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#jump-to-vWork">Volunteer Work</a></li>
