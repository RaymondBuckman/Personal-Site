    ...
    render() {     
        ...
        <div> 
            <div className="intro-1-div" id="top-of-page">
                ...
                <img id="down-arrow" src="https://png.icons8.com/downward-arrow/ios7/73/ffffff" alt="scroll down" style={styles[this.state.down_arrow_state]} onClick={this.scrollDown} onMouseEnter={this.opaqueDownArrow.bind(this)} onMouseLeave={this.transparentDownArrow.bind(this)}></img>            
            </div>
