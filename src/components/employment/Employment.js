            ...
            <div className="Employment-1">
                <ul className="flex-container">
                    ...
                    <li id="jump-to-employment" className="flex-item">
                        ...
                        <p id="employment-paragraph" className="scrollmagic-fade-in">What have I been doing since graduation? Everything you see on HGTV! Painting, demolition, kitchen design, installing back splash, managing workers, pest control, installing cabinets, maintaining properies...you name it, I've done it. What does this have to do with front end web develoment, you ask? It shows I can work long hours, perform under pressure, communicate well, be decisive, & get 'er done! I also believe that my love of sleek, consistent, & modern design comes through on both this site & other projects on my <a id="github-page" href="https://github.com/RaymondBuckman" target="_blank">GitHub page</a>. I've also done a brief stint as an exhibitor at ARM TechCon. </p>
                    </li>
                </ul>
            </div>
